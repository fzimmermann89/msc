...
The result of a simulation for a thick 5\,um Copper foil, rotated 45° with respect to the beam (200\,nm focus FWHM), measured with an detector with 50\,um pixel size placed in a distance of 1\,m  perpendicular to the beam is shown in \fref{fig:simfoil}.
\begin{figure}
	\centering
	\includegraphics[width=0.5\linewidth]{images/sim_foil5umCu.pdf}
	\label{fig:simfoil}
\end{figure}