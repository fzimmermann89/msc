...
Three factors determine the structure factor of these samples: The structure factor of the focus, the structure factor of points following the poison sphere distribution  and the structure factor of a single sphere (see \fref{fig:multisphere1} and \fref{fig:multiphere3}). 
