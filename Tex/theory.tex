...
-\frac{\sigma}{\sqrt{2}\tau_p}
	\right] ,
	\end{align}
	with the complementary error function $\erfc=\frac{2}{\sqrt{\pi}}\int_x^\infty e^{-z^2}\diff z$ an approximation can be made if the pulse length is long in comparison the to coherence time,
\begin{align}
K(t)&\approx \sqrt{\frac{2{\ln 2}}{\pi}}\frac{1}{ \tau} e^{-\left(\sqrt{2\ln 2}\frac{t}{\tau}\right)^2} .
\end{align}
...
As the used X-ray detectors are polarization insensitive and X-ray fluorescence is unpolarized, there are two independent polarization modes giving $M_P = 2$  
