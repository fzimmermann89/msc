...
If, on the other hand, the phase difference $\Delta \phi$ is not fixed but completely random and therefore averages out in \fref{eq:interference}, the visibility goes to 0 and the waves are regarded as \textit{incoherent}.
...
and the visibility can be identified as the modulus of $g_1$ \cite{loudon2000,ou2017}.
...
\paragraph{Second order coherence $g_2$}
