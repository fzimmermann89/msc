...
\usepackage{graphicx}
\usepackage{xcolor}
\usepackage[textwidth=160mm,bottom=25mm,top=25mm,headsep=8mm,bindingoffset=10mm]{geometry}
\usepackage{listings}
\usepackage{fancybox}
...
\usepackage[autostyle]{csquotes} %anfuerungszeichen
\MakeOuterQuote{"}
...
%abstände
\usepackage{titlesec}
\titlespacing\section{0pt}{10pt plus 8pt minus 4pt}{0pt plus 2pt minus 4pt}
...
\setlength{\abovedisplayskip}{-6pt plus 5pt}
\setlength{\belowdisplayskip}{-6pt plus 5pt}
\setlength{\abovedisplayshortskip}{-6pt plus 5pt}
\setlength{\belowdisplayshortskip}{-6pt plus 5pt}
%1.5 zeilig
\usepackage{setspace}
...
%hyperref
\usepackage[bookmarksdepth=subsection,pdfa]{hyperref} %pdf-Inhaltsverzeichnis und pdf-Links
\hypersetup{
	pdfborder={0 0 0}, 
